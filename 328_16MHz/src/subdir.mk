...
<<<<<<< HEAD
	avr-g++ -I"/home/frans/arduino/RadioHead_Core/src" -Wall -g2 -gstabs -Os -ffunction-sections -fdata-sections -fno-exceptions -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
...
src/%.o: ../src/%.c
	...
	avr-gcc -I"/home/frans/arduino/RadioHead_Core/src" -Wall -g2 -gstabs -Os -ffunction-sections -fdata-sections -ffunction-sections -fdata-sections -std=gnu99 -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
=======
...
>>>>>>> branch 'master' of https://github.com/fransb/RadioHead_Core
	@echo 'Finished building: $<'
	@echo ' '
